    ...
    const data = [
        {
            ...
            section_1: {
                ...
                title: 'Создание 2D-анимаций',
                subTitle: 'Мы создаем 2D-графику и анимации ',
                text: ' для рекламного видео-контента (светодиодные экраны и пр.), а так же макеты наружной рекламы и корпоративной полиграфии. Данные элементы являются мощным инструментом в мире маркетинга и дизайна, и позволяют представить продукты, проекты и концепции в наиболее привлекательном виде, захватывая внимание и вызывая эмоции у зрителей.',
                text_2: 'В современном мире, где визуальный контент играет ключевую роль в привлечении внимания клиента и убеждении аудитории, создание качественного контента становится необходимостью для рекламодателя. Мы специализируемся на творческом процессе превращения идей в реальность через впечатляющие визуальные образы.',
            },
            section_2: {
                // title: 'Наши услуги:',
                // model: [
